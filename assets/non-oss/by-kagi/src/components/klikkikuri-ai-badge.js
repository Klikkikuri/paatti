 ...
 *
 * The icon is a solid silhouette filled with `currentColor`, so it inherits the
 * headline's colour and needs no knockout. See src/components/badge-style.js for
 * why no explicit light/dark colours are declared here.
 *
